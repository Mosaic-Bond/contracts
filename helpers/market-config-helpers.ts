...
import { TestnetCrypto } from "../markets/testnet-crypto";
import { TestnetReax } from "../markets/testnet-reax";
import { AaveMarket } from "../markets/test";
import MainnetCrypto from "../markets/mainnet-crypto";
import MainnetReax from "../markets/mainnet-reax";
import { TestnetMosaicTelos } from "../markets/testnet-mosaic-telos";
import TestnetCryptoTelos from "../markets/testnet-crypto-telos";

declare var hre: HardhatRuntimeEnvironment;

export enum ConfigNames {
  TestnetMosaicTelos = "TestnetMosaicTelos",
  TestnetReax = "TestnetReax",
  TestnetCrypto = "TestnetCrypto",
  MainnetReax = "MainnetReax",
  MainnetCrypto = "MainnetCrypto",
  Test = "Test",
  TestnetCryptoTelos = "TestnetCryptoTelos"
}
...
export const loadPoolConfig = (configName: ConfigNames): PoolConfiguration => {
  switch (configName) {
    case ConfigNames.TestnetCrypto:
      return TestnetCrypto;
    case ConfigNames.TestnetReax:
      return TestnetReax;
    case ConfigNames.TestnetMosaicTelos:
      return TestnetMosaicTelos;
    case ConfigNames.TestnetCryptoTelos:
      return TestnetCryptoTelos;
    case ConfigNames.MainnetCrypto:
      return MainnetCrypto;
    case ConfigNames.MainnetReax:
      return MainnetReax;
    default:
      throw new Error(
