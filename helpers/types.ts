...
export type tDiaKey = string;
export type tPythFeedID = string;
...
export type iMosaicPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "DAI" | "USDC" | "WBTC" | "WETH"
>;

export type iMantlePoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
...
export type iTelosPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  "TLOS" | "USDC" | "USDT" | "BTCb" | "ETH"
>;

export type iMultiPoolsAssets<T> = iAssetCommon<T> | iMosaicPoolAssets<T>;

export type iAavePoolTokens<T> = Omit<iMosaicPoolAssets<T>, "ETH">;
...
export interface iTelosParamsPerNetwork<T> {
  [eTelosNetwork.telos]: T;
  [eTelosNetwork.telosTestnet]: T;
}
...
export interface OracleConfig {
  kind: "PythOracle" | "DIAOracle" | "PriceOracle";
  address: string;
  config: IDiaFeedKey | IPythFeedID | ITokenAddress;
...
export interface IBaseConfiguration {
  ...
  FallbackOracle?: OracleConfig;
  PriceOracle: OracleConfig;
...
export interface IMosaicConfiguration extends ICommonConfiguration {
  // ReservesConfig: iMosaicPoolAssets<IReserveParams>;
}
...
export interface IDiaFeedKey {
  [token: string]: tDiaKey;
}

export interface IPythFeedID {
  [token: string]: tPythFeedID;
}
