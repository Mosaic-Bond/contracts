import { AssetType, eArbitrumNetwork, eEthereumNetwork, eMantleNetwork, IMosaicConfiguration, TransferStrategy } from "../../helpers/types";
...
export const TestnetReax: IMosaicConfiguration = {
    ...
    ReserveAssets: {
        [eMantleNetwork.mantleTestnet]: {
            ETH: "0x86fb905bd14923fd66a5353d2cda955564ddb9aa",
            MNT: "0x5b156dca04f775046064032e1f5e45fd1fcca1e0",
            USDC: "0xbe28691f9032333076f64e8cbd18beebd84dfc01",
        },
    },
    EModes: {
        // StableEMode: {
