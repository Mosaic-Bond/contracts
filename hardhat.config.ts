...
import { DEFAULT_NAMED_ACCOUNTS, eMantleNetwork, eTelosNetwork, getCommonNetworkConfig } from './helpers';
...
const config: any = {
  ...
  networks: {
    ...
    [eMantleNetwork.mantleTestnet]: {...getCommonNetworkConfig(
    ...
    [eTelosNetwork.telos]: {...getCommonNetworkConfig(
      eTelosNetwork.telos,
      40,
      ),
      accounts : [PRIVATE_KEY],
    ...
    [eTelosNetwork.telosTestnet]: {...getCommonNetworkConfig(
  ...
  etherscan:{
    apiKey: {
      mantleTestnet: '2eaa7af4-d22c-479a-8ef7-3f0c0750a8a8',
      mantle: '6e1e4c11657c62dc1e4349d024de9e28'
    },
    customChains: [
      {
