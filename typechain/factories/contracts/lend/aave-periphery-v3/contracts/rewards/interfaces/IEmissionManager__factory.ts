...
} from "../../../../../../../contracts/lend/aave-periphery-v3/contracts/rewards/interfaces/IEmissionManager";
...
export class IEmissionManager__factory {
  ...
  static createInterface(): IEmissionManagerInterface {
    return new utils.Interface(_abi) as IEmissionManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IEmissionManager {
    return new Contract(address, _abi, signerOrProvider) as IEmissionManager;
  }
}
