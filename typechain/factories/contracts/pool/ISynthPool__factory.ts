...
import type {
  ISynthPool,
  ISynthPoolInterface,
} from "../../../contracts/pool/ISynthPool";
...
export class ISynthPool__factory {
  static readonly abi = _abi;
  static createInterface(): ISynthPoolInterface {
    return new utils.Interface(_abi) as ISynthPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISynthPool {
    return new Contract(address, _abi, signerOrProvider) as ISynthPool;
  }
}
