...
import type {
  ...
  GovernancePowerDelegationERC20Interface,
} from "../../../../../../../@aave/safety-module/contracts/proposals/extend-stkaave-distribution/StakedTokenV2Rev3.sol/GovernancePowerDelegationERC20";
...
export class GovernancePowerDelegationERC20__factory {
  ...
  static createInterface(): GovernancePowerDelegationERC20Interface {
    return new utils.Interface(_abi) as GovernancePowerDelegationERC20Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as GovernancePowerDelegationERC20;
  }
}
