...
import type {
  StakedTokenV2Rev3,
  StakedTokenV2Rev3Interface,
} from "../../../../../../../@aave/safety-module/contracts/proposals/extend-stkaave-distribution/StakedTokenV2Rev3.sol/StakedTokenV2Rev3";
...
type StakedTokenV2Rev3ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: StakedTokenV2Rev3ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class StakedTokenV2Rev3__factory extends ContractFactory {
  ...
  override attach(address: string): StakedTokenV2Rev3 {
    return super.attach(address) as StakedTokenV2Rev3;
  }
  override connect(signer: Signer): StakedTokenV2Rev3__factory {
    return super.connect(signer) as StakedTokenV2Rev3__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): StakedTokenV2Rev3Interface {
    return new utils.Interface(_abi) as StakedTokenV2Rev3Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StakedTokenV2Rev3 {
    return new Contract(address, _abi, signerOrProvider) as StakedTokenV2Rev3;
  }
}
