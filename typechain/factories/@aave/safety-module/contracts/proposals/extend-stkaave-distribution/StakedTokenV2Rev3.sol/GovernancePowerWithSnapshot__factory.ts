...
import type {
  ...
  GovernancePowerWithSnapshotInterface,
} from "../../../../../../../@aave/safety-module/contracts/proposals/extend-stkaave-distribution/StakedTokenV2Rev3.sol/GovernancePowerWithSnapshot";
...
export class GovernancePowerWithSnapshot__factory {
  static readonly abi = _abi;
  static createInterface(): GovernancePowerWithSnapshotInterface {
    return new utils.Interface(_abi) as GovernancePowerWithSnapshotInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as GovernancePowerWithSnapshot;
  }
}
