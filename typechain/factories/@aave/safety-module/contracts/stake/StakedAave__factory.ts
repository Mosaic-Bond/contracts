...
import type {
  StakedAave,
  StakedAaveInterface,
} from "../../../../../@aave/safety-module/contracts/stake/StakedAave";
...
type StakedAaveConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: StakedAaveConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class StakedAave__factory extends ContractFactory {
  constructor(...args: StakedAaveConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): StakedAave {
    return super.attach(address) as StakedAave;
  }
  override connect(signer: Signer): StakedAave__factory {
    return super.connect(signer) as StakedAave__factory;
  }
