...
import type {
  StakedAaveV2,
  StakedAaveV2Interface,
} from "../../../../../@aave/safety-module/contracts/stake/StakedAaveV2";
...
type StakedAaveV2ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: StakedAaveV2ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class StakedAaveV2__factory extends ContractFactory {
  constructor(...args: StakedAaveV2ConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): StakedAaveV2 {
    return super.attach(address) as StakedAaveV2;
  }
  override connect(signer: Signer): StakedAaveV2__factory {
    return super.connect(signer) as StakedAaveV2__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): StakedAaveV2Interface {
    return new utils.Interface(_abi) as StakedAaveV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StakedAaveV2 {
    return new Contract(address, _abi, signerOrProvider) as StakedAaveV2;
  }
}
