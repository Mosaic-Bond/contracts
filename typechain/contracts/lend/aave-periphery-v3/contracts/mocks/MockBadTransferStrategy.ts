...
export interface MockBadTransferStrategyInterface extends utils.Interface {
  functions: {
...
export interface MockBadTransferStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockBadTransferStrategyInterface;
