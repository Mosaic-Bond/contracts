...
export interface BaseParaSwapBuyAdapterInterface extends utils.Interface {
  functions: {
...
export interface BaseParaSwapBuyAdapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseParaSwapBuyAdapterInterface;
