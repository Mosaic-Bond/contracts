...
export interface ParaSwapRepayAdapterInterface extends utils.Interface {
  functions: {
    ...
    "swapAndRepay(address,address,uint256,uint256,uint256,uint256,bytes,(uint256,uint256,uint8,bytes32,bytes32))": FunctionFragment;
...
export interface ParaSwapRepayAdapter extends BaseContract {
  ...
  functions: {
    ...
    swapAndRepay(
      ...
      debtRepayAmount: PromiseOrValue<BigNumberish>,
      debtRateMode: PromiseOrValue<BigNumberish>,
      buyAllBalanceOffset: PromiseOrValue<BigNumberish>,
      paraswapData: PromiseOrValue<BytesLike>,
      permitSignature: BaseParaSwapAdapter.PermitSignatureStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
