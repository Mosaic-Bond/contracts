...
export declare namespace IPool {
  export type GetUserAccountDataStructStruct = {
    user: PromiseOrValue<string>;
    pythUpdateData: PromiseOrValue<BytesLike>[];
  };

  export type GetUserAccountDataStructStructOutput = [string, string[]] & {
    user: string;
    pythUpdateData: string[];
  };

  export type SupplyWithPermitParamsStruct = {
  ...
  export type SupplyWithPermitParamsStructOutput = [
    string,
    BigNumber,
    string,
    number,
...
export interface PoolInterface extends utils.Interface {
  functions: {
    ...
    "borrow(address,uint256,uint256,uint16,address,bytes[])": FunctionFragment;
    ...
    "getUserAccountData((address,bytes[]))": FunctionFragment;
    ...
    "liquidationCall(address,address,address,uint256,bool,bytes[])": FunctionFragment;
    ...
    "setUserEMode(uint8,bytes[])": FunctionFragment;
    ...
    "updateAssetFees(address[],uint256[],uint256[])": FunctionFragment;
    "updateBridgeProtocolFee(uint256)": FunctionFragment;
    "updateFlashloanPremiums(uint128,uint128)": FunctionFragment;
    "withdraw(address,uint256,address,bytes[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    ...
    values: [IPool.GetUserAccountDataStructStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [IPool.SupplyWithPermitParamsStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateAssetFees",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<BigNumberish>[]
  ...
  events: {
    ...
    "UpdateAssetFees(address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "UpdateAssetFees"): EventFragment;
...
export interface UpdateAssetFeesEventObject {
  asset: string;
  supplyFee: BigNumber;
  borrowFee: BigNumber;
}
export type UpdateAssetFeesEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  UpdateAssetFeesEventObject
>;

export type UpdateAssetFeesEventFilter = TypedEventFilter<UpdateAssetFeesEvent>;
...
export interface Pool extends BaseContract {
  ...
  functions: {
    ...
    getUserAccountData(
      params: IPool.GetUserAccountDataStructStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    supplyWithPermit(
      params: IPool.SupplyWithPermitParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    updateAssetFees(
      assets: PromiseOrValue<string>[],
      supplyFee: PromiseOrValue<BigNumberish>[],
  ...
  filters: {
    ...
    "UpdateAssetFees(address,uint256,uint256)"(
      asset?: null,
      supplyFee?: null,
      borrowFee?: null
    ): UpdateAssetFeesEventFilter;
    UpdateAssetFees(
      asset?: null,
      supplyFee?: null,
      borrowFee?: null
