...
export declare namespace Pool_V2 {
...
export interface Pool_V2Interface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getUserAccountData((address,bytes[]))"
      | "getUserConfiguration"
      | "getUserEMode"
      | "initReserve"
      | "initialize"
      | "liquidationCall(address,address,address,uint256,bool)"
      | "liquidationCall(address,address,address,uint256,bool,bytes[])"
      | "mintToTreasury"
      | "mintUnbacked"
  ...
  encodeFunctionData(
    functionFragment: "getUserAccountData((address,bytes[]))",
    values: [Pool_V2.GetUserAccountDataStructStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "liquidationCall(address,address,address,uint256,bool,bytes[])",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "setUserEMode(uint8,bytes[])",
...
export interface Pool_V2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Pool_V2Interface;
  ...
  functions: {
    ...
    "getUserAccountData((address,bytes[]))"(
      params: Pool_V2.GetUserAccountDataStructStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
