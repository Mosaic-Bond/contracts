...
export interface SynthLiquidationInterface extends utils.Interface {
  functions: {
    ...
    "liquidateAndSwap(address,address,address,uint256,(uint8,((bytes32,uint256,uint256,uint256,bytes)[],int256[],address[],bool)[],address,uint256),bytes[])": FunctionFragment;
...
export interface SynthLiquidation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthLiquidationInterface;
