...
export interface MintableDelegationERC20Interface extends utils.Interface {
  functions: {
...
export interface MintableDelegationERC20 extends BaseContract {
  ...
  functions: {
    ...
    delegate(
      delegateeAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
