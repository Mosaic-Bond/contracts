...
export interface MockInitializableFromConstructorImpleInterface
  ...
  getFunction(
    nameOrSignatureOrTopic: "REVISION" | "initialize" | "value"
  ): FunctionFragment;
...
export interface MockInitializableFromConstructorImple extends BaseContract {
