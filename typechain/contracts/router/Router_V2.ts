...
export declare namespace Router_V2 {
  ...
  export type SwapDataStructOutput = [
    number,
    Router_V2.SwapStructOutput[],
    string,
    BigNumber
  ] & {
    kind: number;
    swaps: Router_V2.SwapStructOutput[];
    recipient: string;
    deadline: BigNumber;
  };
}

export interface Router_V2Interface extends utils.Interface {
  functions: {
    ...
    "swap((uint8,((bytes32,uint256,uint256,uint256,bytes)[],int256[],address[],bool)[],address,uint256),uint256,bytes[])": FunctionFragment;
    "swapGivenInQuery((uint8,((bytes32,uint256,uint256,uint256,bytes)[],int256[],address[],bool)[],address,uint256),bytes[])": FunctionFragment;
    "swapGivenOutQuery((uint8,((bytes32,uint256,uint256,uint256,bytes)[],int256[],address[],bool)[],address,uint256),bytes[])": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [
      Router_V2.SwapDataStruct,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>[]
    ]
  ): string;
  encodeFunctionData(
    functionFragment: "swapGivenInQuery",
    values: [Router_V2.SwapDataStruct, PromiseOrValue<BytesLike>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "swapGivenOutQuery",
    values: [Router_V2.SwapDataStruct, PromiseOrValue<BytesLike>[]]
  ): string;
  encodeFunctionData(
...
export interface Router_V2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Router_V2Interface;
  ...
  functions: {
    ...
    swap(
      swapData: Router_V2.SwapDataStruct,
