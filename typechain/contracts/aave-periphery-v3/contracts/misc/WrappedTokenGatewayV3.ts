...
export interface WrappedTokenGatewayV3Interface extends utils.Interface {
  functions: {
    "borrowETH(address,uint256,uint256,uint16,bytes[])": FunctionFragment;
    ...
    "withdrawETH(address,uint256,address,bytes[])": FunctionFragment;
    "withdrawETHWithPermit(address,uint256,address,uint256,uint8,bytes32,bytes32,bytes[])": FunctionFragment;
  };
