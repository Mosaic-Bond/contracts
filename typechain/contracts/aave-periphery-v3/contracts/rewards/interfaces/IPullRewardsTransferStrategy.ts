...
export interface IPullRewardsTransferStrategyInterface extends utils.Interface {
  functions: {
...
export interface IPullRewardsTransferStrategy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPullRewardsTransferStrategyInterface;
