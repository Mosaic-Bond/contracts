...
export interface ISynthPoolInterface extends utils.Interface {
  functions: {
    ...
    "estimateSwap(address,uint256,address,uint8,address,bytes[])": FunctionFragment;
...
export interface ISynthPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISynthPoolInterface;
