...
export interface DIAOracleInterface extends utils.Interface {
  functions: {
    "BASE_CURRENCY()": FunctionFragment;
    "BASE_CURRENCY_UNIT()": FunctionFragment;
    "diaOracle()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "diaOracle", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "diaOracle", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getAssetPrice",
    data: BytesLike
  ): Result;
  ...
  events: {
    "AssetSourceUpdated(address,string)": EventFragment;
...
export interface DIAOracle extends BaseContract {
  ...
  functions: {
    ...
    diaOracle(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    diaOracle(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    diaOracle(overrides?: CallOverrides): Promise<PopulatedTransaction>;
