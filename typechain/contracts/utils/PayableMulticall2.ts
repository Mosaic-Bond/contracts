...
export declare namespace PayableMulticall2 {
...
export interface PayableMulticall2Interface extends utils.Interface {
  functions: {
    "aggregate((address,bytes,uint256)[])": FunctionFragment;
    "blockAndAggregate((address,bytes,uint256)[])": FunctionFragment;
    ...
    "tryAggregate(bool,(address,bytes,uint256)[])": FunctionFragment;
    "tryBlockAndAggregate(bool,(address,bytes,uint256)[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    ...
    values: [PayableMulticall2.CallStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<boolean>, PayableMulticall2.CallStruct[]]
  ): string;
  encodeFunctionData(
...
export interface PayableMulticall2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PayableMulticall2Interface;
  ...
  functions: {
    aggregate(
      calls: PayableMulticall2.CallStruct[],
  ...
  callStatic: {
    ...
    blockAndAggregate(
      ...
      [BigNumber, string, PayableMulticall2.ResultStructOutput[]] & {
        blockNumber: BigNumber;
        blockHash: string;
        returnData: PayableMulticall2.ResultStructOutput[];
      }
    >;
    ...
    tryAggregate(
      ...
      calls: PayableMulticall2.CallStruct[],
      overrides?: CallOverrides
    ): Promise<PayableMulticall2.ResultStructOutput[]>;
