...
export declare namespace PayableMulticall {
...
export interface PayableMulticallInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PayableMulticall.CallStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<boolean>, PayableMulticall.CallStruct[]]
  ): string;
  encodeFunctionData(
...
export interface PayableMulticall extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PayableMulticallInterface;
  ...
  functions: {
    aggregate(
      calls: PayableMulticall.CallStruct[],
  ...
  callStatic: {
    ...
    blockAndAggregate(
      ...
      [BigNumber, string, PayableMulticall.ResultStructOutput[]] & {
        blockNumber: BigNumber;
        blockHash: string;
        returnData: PayableMulticall.ResultStructOutput[];
      }
    >;
    ...
    tryAggregate(
      ...
      calls: PayableMulticall.CallStruct[],
      overrides?: CallOverrides
    ): Promise<PayableMulticall.ResultStructOutput[]>;
