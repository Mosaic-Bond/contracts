...
export interface MockL2PoolInterface extends utils.Interface {
  functions: {
    ...
    "borrow(bytes32,bytes[])": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "POOL_REVISION"
      | "backUnbacked"
      | "borrow(address,uint256,uint256,uint16,address,bytes[])"
      | "borrow(bytes32,bytes[])"
      ...
      | "withdraw(address,uint256,address,bytes[])"
  ...
  encodeFunctionData(
    functionFragment: "borrow(address,uint256,uint256,uint16,address,bytes[])",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "borrow(bytes32,bytes[])",
  ...
  encodeFunctionData(
    functionFragment: "withdraw(address,uint256,address,bytes[])",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
  ...
  encodeFunctionData(
    functionFragment: "withdraw(bytes32,bytes[])",
    values: [PromiseOrValue<BytesLike>, PromiseOrValue<BytesLike>[]]
  ): string;
...
export interface MockL2Pool extends BaseContract {
