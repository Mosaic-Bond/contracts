...
export interface MockATokenRepaymentInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "MockRepayment(address,address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "MockRepayment"): EventFragment;
...
export interface MockRepaymentEventObject {
  user: string;
  onBehalfOf: string;
  amount: BigNumber;
}
export type MockRepaymentEvent = TypedEvent<
  [string, string, BigNumber],
  MockRepaymentEventObject
>;

export type MockRepaymentEventFilter = TypedEventFilter<MockRepaymentEvent>;
...
export interface MockATokenRepayment extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockATokenRepaymentInterface;
  ...
  filters: {
    ...
    "MockRepayment(address,address,uint256)"(
      user?: null,
      onBehalfOf?: null,
      amount?: null
    ): MockRepaymentEventFilter;
    MockRepayment(
      user?: null,
      onBehalfOf?: null,
      amount?: null
